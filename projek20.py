...
# Fungsi untuk menambahkan background gambar dengan overlay
...
# Tambahkan background dengan overlay hitam (opacity 0.7)
...
def kesimpulan(usia, berat_badan, total_gula, kebutuhan_gula, nama_pengguna):
    ...
    if total_gula > kebutuhan_gula:
        ...
        warna = "red"  # Warna merah jika konsumsi gula lebih dari kebutuhan
        ...
        warna = "red"  # Warna merah jika konsumsi gula kurang dari setengah kebutuhan
    else:
